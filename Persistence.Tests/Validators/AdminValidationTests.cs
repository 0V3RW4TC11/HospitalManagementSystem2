...
namespace Tests.Validators
{
    ...
    internal class AdminValidationTests
    {
        ...
        private static void CreateUowAndRepoMock(out Mock<IUnitOfWork> uowMock, out Mock<IRepository<Domain.Entities.Admin>> repoMock)
        {
            uowMock = new();
            repoMock = new();
        ...
        public async Task UpdateValidator_EmailIsUsedByAnotherAdmin_ShouldHaveValidationError()
        {
            ...
            repoMock.Setup(r => r.AnyAsync(It.IsAny<Specifications.Entity.EntityByIdSpec<Domain.Entities.Admin>>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(true);
