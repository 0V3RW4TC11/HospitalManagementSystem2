...
namespace Tests.Validators
{
    ...
    internal class SpecializationValidationTests
    {
        ...
        private static void CreateUowAndRepoMock(out Mock<IUnitOfWork> uowMock, out Mock<IRepository<Specialization>> repoMock)
        {
            uowMock = new();
            repoMock = new();
        ...
        public async Task UpdateValidator_NameIsUsedByAnotherSpecialization_ShouldHaveValidationError()
        {
            ...
            repoMock.Setup(r => r.AnyAsync(It.IsAny<Specifications.Entity.EntityByIdSpec<Specialization>>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(true);
